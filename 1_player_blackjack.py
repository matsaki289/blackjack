...
def player_bet():
    ...
    global bet
    bet = int(input('You currently have {0} chips in your stack. How much will you bet? '.format(player1_stack)))
    while bet > player1_stack or bet < 1:
        bet = int(input("Please bet a value less than {0} and more than 0. How much will you bet? ".format(player1_stack + 1)))
